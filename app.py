...
if uploaded_file is not None:
    ...
    if uploaded_file.type.startswith('image'):
        ...
        col1.header("HSV Segmentation Parameters")
        col1.markdown("Adjust the sliders below to set the HSV segmentation parameters.", unsafe_allow_html=True)

        lower_h = col1.slider("Lower Hue", 0, 179, 0, help="Set the lower bound for hue.")
        lower_s = col1.slider("Lower Saturation", 0, 255, 50, help="Set the lower bound for saturation.")
        lower_v = col1.slider("Lower Value", 0, 255, 50, help="Set the lower bound for value.")
        upper_h = col2.slider("Upper Hue", 0, 179, 179, help="Set the upper bound for hue.")
        upper_s = col2.slider("Upper Saturation", 0, 255, 255, help="Set the upper bound for saturation.")
        upper_v = col2.slider("Upper Value", 0, 255, 255, help="Set the upper bound for value.")
        ...
        lower_h = st.sidebar.slider("Lower Hue", 0, 179, 0, help="Set the lower bound for hue.")
        lower_s = st.sidebar.slider("Lower Saturation", 0, 255, 50, help="Set the lower bound for saturation.")
        lower_v = st.sidebar.slider("Lower Value", 0, 255, 50, help="Set the lower bound for value.")
        upper_h = st.sidebar.slider("Upper Hue", 0, 179, 179, help="Set the upper bound for hue.")
        upper_s = st.sidebar.slider("Upper Saturation", 0, 255, 255, help="Set the upper bound for saturation.")
        upper_v = st.sidebar.slider("Upper Value", 0, 255, 255, help="Set the upper bound for value.")
